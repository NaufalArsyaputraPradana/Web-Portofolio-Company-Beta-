...
@section('content')
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form action="" id="form_cari" method="post">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Cari judul atau kategori" name="cari" id="cari">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="Tblog" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>Title</th>
                                <th>Category</th>
    ...
    <!--
        Form Modal untuk Menambahkan Data Blog
    -->
    ...
    <!--
        Form Modal untuk Mengupdate Data Blog
    -->
    ...
    <script>
        ...
        $('document').ready(function(e) {
            ...
            $("#proses_add").click(function() {
                ...
                $.ajax({
                    url: "{{ URL::route('editor.blog.store') }}",
                    data: postData,
                    type: "POST",
                    dataType: "JSON",
                    cache: false,
            ...
            // 
            $("#Tblog tbody").on('click', '.btnUpdate', function() {
                let data = Tblog.row($(this).parents('tr')).data();
                let idData = data.id;
                $.ajax({
                    url: "{{ URL::route('editor.blog.detail') }}",
                    type: "GET",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        'id': idData
            ...
            $("#proses_update").click(function() {
                ...
                $.ajax({
                    url: "{{ URL::route('editor.blog.update') }}",
                    data: postData,
                    type: "POST",
                    dataType: "JSON",
                    cache: false,
            ...
            // 
            $("#Tblog tbody").on('click', '.btnDelete', function() {
                let data = Tblog.row($(this).parents('tr')).data();
                let idData = data.id;
                Swal.fire({
                    title: "Are you sure?",
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ URL::route('editor.blog.delete') }}",
                            type: "DELETE",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                'id': idData
