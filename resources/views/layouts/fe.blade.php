...
<head>
    ...
    <title>First Studio</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('template_admin/img/logo_first-studio.png') }}" />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('template_fe/assets/img/navbar-logo.svg') }}"
                    alt="..." /></a>
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                            ...
                            <img class="img-fluid" src="{{ asset('template_fe/assets/img/portfolio/4.jpg')}}" alt="..." />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                            ...
                            <img class="img-fluid" src="{{ asset('template_fe/assets/img/portfolio/5.jpg')}}" alt="..." />
                        </a>
                        <div class="portfolio-caption">
